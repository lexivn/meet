/*
** BEHAVIOR ACCEPTANCE TESTING (BDD)
** Writing Acceptance for Feature 1 using jest-cucumber
*/
...
defineFeature(feature, (test) => {
  ...
  test('User should see a list of suggestions when they search for a city.', ({
    ...
    when('user starts typing in the city textbox', async () => {
      ...
      await user.type(citySearchInput, 'Berlin'); // Simulates to type Berlin in the textbox
    });
